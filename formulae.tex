...
\item Generally useful solution ideas (always consider!): divide and conquer, binary search, precomputation, output-sensitive algorithms, meet-in-the-middle, use different algos for different situations, hashing
